          ...
          <li class="ruby-menu-mega-blog package">
            ...
            <div style={{ height: "200px", width: "670px" }} className="">
              <ul class="ruby-menu-mega-blog-nav">
                    ...
                    <div class="ruby-row">
                      ...
                      <div class="ruby-col-4">
                        <span class="ruby-c-title ruby-margin-10">
                          <Link to={"/appointment"}>
                            <a>DEEP RELAXATION SESSION</a>
                          </Link>
                        </span>

                        <span class="ruby-c-content">
                          Deep relaxation sessions provide a warm space so that
                          the clients take control of finding a solution while
                          relaxing from the comfort of their couch. Sessions are
                ...
                <li>
                  <a href="/appointment">3*60 Minutes Session</a>
                  <div
                    class="ruby-grid ruby-grid-lined"
                    style={{ height: "220px", width: "700px" }}
                  >
                ...
                <li>
                  <a href="/appointment">5*60 Minutes Session</a>
                  <div
                    class="ruby-grid ruby-grid-lined"
                    style={{ height: "220px", width: "700px" }}
                  >
                    <div class="ruby-row">
                      ...
                      <div class="ruby-col-4">
                        ...
                        <span class="ruby-c-content">
                          This package is ideal for someone who wants a
                          long-lasting transformation such as weight management,
                          treating insomnia, etc. The first session is involved
