...
const InfoSection = ({ heading, peragraphOne, reverse, image }) => {
  ...
  return (
    <section className="section-info welcome">
      <div className="row">
      <div className="col-md-6">
          <img src={image} alt="" className="img-fluid" />
        </div>
        <div className="col-md-6">
            <p className="welcome-text">Well done! As you are on this page you have taken the first step to make a difference in your present life and/or in the lives of the people around you, that matter to you. These changes include anything starting from dealing with overthinking, anxiety, low self-esteem, sleeping difficulties, depression, and many more from the comfort of your couch.
